...
import { PointCloudFillButton } from "./PointCloudFillButton";
import { PointCloudFillQuickSettingsView } from "./PointCloudFillQuickSettingsView";

const NAME = "POINTCLOUD_FILL";

export class PointCloudFill extends Tool<PointCloud> {
	...
	public override getToolButtonComponent(): FC<ToolButtonProps> {
		return PointCloudFillButton;
	}
	public override getQuickSettingsComponent(): FC<ToolQuickSettingsProps> {
		return PointCloudFillQuickSettingsView;
	}

	public fill(): void {
		const indices = this.bvhMesh!.geometry.index!.array;
